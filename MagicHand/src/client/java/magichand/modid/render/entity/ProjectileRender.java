...
public class ProjectileRender extends EntityRenderer<Projectile> {
    ...
    public ProjectileRender(EntityRendererFactory.Context context)
    {
        super(context);
    ...
    @Override
    public void render(Projectile magicalAttack, float yaw, float tickDelta, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light) {
        ...
        ProjectileRender.vertex(vertexConsumer, matrix4f, matrix3f, -0.5f, -0.25f, rgb[0], rgb[1], rgb[2], aparrentU1, aparrentV2, light_l);
        ProjectileRender.vertex(vertexConsumer, matrix4f, matrix3f, 0.5f, -0.25f, rgb[0], rgb[1], rgb[2], aparrentU2, aparrentV2, light_l);
        ProjectileRender.vertex(vertexConsumer, matrix4f, matrix3f, 0.5f, 0.75f, rgb[0], rgb[1], rgb[2], aparrentU2, aparrentV1, light_l);
        ProjectileRender.vertex(vertexConsumer, matrix4f, matrix3f, -0.5f, 0.75f, rgb[0], rgb[1], rgb[2], aparrentU1, aparrentV1, light_l);
